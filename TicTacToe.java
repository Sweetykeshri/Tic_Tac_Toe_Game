...
public class TicTacToe implements ActionListener {
    ...
    int count = 0;
    String strZero = "", strOne="", str="", firstPlayer="", secondPlayer="";
    boolean win = false;
    Color color1 ;

    TicTacToe(String fp, String sp) {
        firstPlayer =fp; secondPlayer=sp;
       
        jf = new JFrame("TicTacToe Game By Ansh");
        jf.setSize(500, 500);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == jb1) {
            ...
            jb1.setFont(new Font("Arial", 1, 55));
            jb1.setText(str);
            jb1.setEnabled(false);
        }
        if (e.getSource() == jb2) {
            jb2.setBackground(color1);
            jb2.setFont(new Font("Arial", 1, 55));
            jb2.setText(str);
            jb2.setEnabled(false);
        }
        if (e.getSource() == jb3) {
            jb3.setBackground(color1);
            jb3.setFont(new Font("Arial", 1, 55));
            jb3.setText(str);
            jb3.setEnabled(false);
        }
        if (e.getSource() == jb4) {
            jb4.setBackground(color1);
            jb4.setFont(new Font("Arial", 1, 55));
            jb4.setText(str);
            jb4.setEnabled(false);
        }
        if (e.getSource() == jb5) {
            jb5.setBackground(color1);
            jb5.setFont(new Font("Arial", 1, 55));
            jb5.setText(str);
        ...
        if (e.getSource() == jb6) {
            ...
            jb6.setFont(new Font("Arial", 1, 55));
            jb6.setText(str);
            jb6.setEnabled(false);
        }
        if (e.getSource() == jb7) {
            jb7.setBackground(color1);
            jb7.setFont(new Font("Arial", 1, 55));
            jb7.setText(str);
            jb7.setEnabled(false);
        }
        if (e.getSource() == jb8) {
            jb8.setBackground(color1);
            jb8.setFont(new Font("Arial", 1, 55));
            jb8.setText(str);
            jb8.setEnabled(false);
        }
        if (e.getSource() == jb9) {
            jb9.setBackground(color1);
            jb9.setFont(new Font("Arial", 1, 55));
            jb9.setText(str);
    ...
    void whoWin() {
       // System.out.println("name of player"+" "+firstPlayer+" "+secondPlayer);
       String playerValue = String.valueOf(str); 
      // System.out.println("PlayerName"+" "+playerValue);
       if (win == true) {
            if(playerValue=="X")
               JOptionPane.showConfirmDialog(jf, "\t Game Result \n Winner Symbol: X \n Winner of this game is :"+" "+firstPlayer+" ");
            if(playerValue=="0")
               
            JOptionPane.showConfirmDialog(jf, "\t Game Result: \n Winner Symbol: 0 \n Winner of this game is :"+" "+secondPlayer+" ");
